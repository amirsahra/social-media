 ...
 */
     ...
     */ 
         ...
         *
         * @return \Jenssegers\Mongodb\Database 
         * @static 
         */ 
         ...
         *
         * @return \Jenssegers\Mongodb\Client 
         * @static 
         */ 
     ...
     */ 
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Jenssegers\Mongodb\Schema\Builder::morphUsingUlids();
        }
                    /**
        ...
        {            //Method inherited from \Illuminate\Database\Schema\Builder         
                        \Jenssegers\Mongodb\Schema\Builder::useNativeSchemaOperationsIfPossible($value);
        }
                    /**
